...
private:
    ...
    Vector3f cookTorrance(const Vector3f &wi, const Vector3f &wo, const Vector3f &N)
    {
        auto V = wo;
        auto L = wi;
...
Vector3f Material::eval(const Vector3f &wi, const Vector3f &wo, const Vector3f &N)
{
    ...
    case MICROFACET_DIFFUSE:
    {
        ...
        if (cosalpha > 0.0f)
        {
            Vector3f micro_diffuse = Ks * cookTorrance(wi, wo, N) + Kd * eval_diffuse(wi, wo, N);
            return micro_diffuse;
        }
        else
        {
            return {};
    ...
    case MICROFACET_GLOSSY:
    {
        ...
        if (cosalpha > 0.0f)
        {
            ...
            Vector3f micro_glossy = Ks * spec + Kd * eval_diffuse(wi, wo, N);
            return micro_glossy;
        }
        else
        {
